...
if length(sz)==4
    newim(newst(1):newen(1), newst(2):newen(2), newst(3):newen(3), newst(4):newen(4)) ...
    = im(oldst(1):olden(1), oldst(2):olden(2), oldst(3):olden(3), oldst(4):olden(4));
elseif length(sz)==3
    newim(newst(1):newen(1), newst(2):newen(2), newst(3):newen(3)) ...
    = im(oldst(1):olden(1), oldst(2):olden(2), oldst(3):olden(3));
end